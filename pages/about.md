...
---
# About
Building community around and gathering knowledge about the world’s heelwalkers.
...
- **Cite** this website: Hopkins, H. Mantophasmatodea Species File. [retrieval date]. <https://mantophasmatodea.speciesfile.org>. See also [Terms of use](#terms-of-use).
...
- Core taxonomic data are exported to and available at the [Catalogue of Life](https://www.catalogueoflife.org/data/taxon/8MP8M) and its [associated API](https://api.checklistbank.org/dataset/3LR/taxon/8MP8M).
